...
export default function SignUpPage () {
  return (
    <div className="flex justify-center min-h-screen bg-gray-50">
        <div className="w-[348px] h-[293px] mt-[200px] mb-[587px]">
          <form>
            <div className="flex flex-col justify-center items-center mb-[64px]">
            <img src="src/pages/오즈코딩스쿨.png" alt="오즈코딩스쿨" className="w-[180px] h-[24px] mb-[27px]" />
            <div className="flex justify-center items-center h-[11px] gap-[12px]">
              <h3 className="font-medium">현재 회원이신가요?</h3>
              <Link to="*" className="text-[#6201E0] no-underline font-medium">로그인하기</Link>
            </div>
            </div>
            ...
            <div className="text-center">
              <Link to="*" className="text-sm underline underline-offset-[2px] text-[16px] text-gray-600">일반회원 가입</Link>
            </div>
          </form>
          </div>
        </div>
